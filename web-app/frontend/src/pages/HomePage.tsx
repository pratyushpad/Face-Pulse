...
const features = [
  ...
  },
  {
    ...
    description: 'Every emotion event logged. Export as CSV or JSON. Filter and search.',
    href: '/history',
  },
]
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <section className="relative z-10 px-8 pt-32 pb-40 max-w-[1200px] mx-auto">
        ...
        <p className="text-[16px] text-text-secondary mt-5 max-w-[480px] leading-[1.65]">
          Powered by face-api.js and TensorFlow.js. Detects 7 emotions with live confidence
          scoring, session analytics, and export.
        </p>
        ...
        <div className="flex items-center gap-3 mt-9 flex-wrap">
          ...
          <Link
            to="/about"
            className="inline-flex items-center gap-2 px-5 py-2.5 text-[14px] font-medium rounded-[8px] bg-transparent border border-border-default text-text-primary hover:bg-hover-overlay transition-colors duration-150"
          >
            How it works
          </Link>
        </div>
      ...
      <section className="relative z-10 max-w-[1200px] mx-auto px-8 pb-20">
        ...
        <div className="flex items-center gap-2 mt-9 text-[12px] text-text-muted">
          <Shield className="w-3.5 h-3.5" />
          <span>Camera frames are processed locally and never uploaded</span>
        </div>
      </section>
    </div>
  )
